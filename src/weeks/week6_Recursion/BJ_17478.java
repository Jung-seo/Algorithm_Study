package weeks.week6_Recursion;

import java.util.Scanner;


//https://www.acmicpc.net/group/workbook/view/17707/57979

public class BJ_17478 { // 재귀함수가 뭔가요.....................
    public static void main(String[] args) {
        ...
        recursion(N, underScore, false);
    }
    static void recursion (int N, String underScore, boolean under) {
        if (under) underScore += "____";
